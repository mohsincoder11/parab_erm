                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myLargeModalLabel">Add Event & Meeting</h5>
                                ...
                                <form id="event-meeting_form" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row" style="padding: 10px;">
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label> Select Event or Meeting Date *</label>
                                            <input type="date" name="event_meeting_date" id="event_meeting_date"
                                                class="form-control">
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label> Select Meeting Proposer Employees * </label>
                                            <select class="form-control select2" name="meeting_proposer_employee"
                                                id="meeting_proposer_employee">
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label> File Attachment - Report *</label>
                                        ...
                                        <div class="form-group" align="center"
                                            ...
                                            <button
                                                formaction="{{ route('admin_process.activity_documents.store-event-meeting') }}"
                            ...
                            <table class="table table-hover non-hover datatable_server" style="width:100%">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th>Location</th>
                                        <th>Department</th>
                                        <th>Event Meeting Date</th>
                                        <th>Proposal Employee</th>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete', function() {
                ...
                swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ route('admin_process.activity_documents.delete-event-meeting') }}",
                            method: "GET",
                            dataType: 'json',
                            data: {
                                id: id,
            ...
            $(document).on('click', '.edit', function() {
                let id = $(this).attr('id');
                $.ajax({
                    url: "{{ route('admin_process.activity_documents.edit-event-meeting') }}",
                    method: "GET",
                    dataType: 'json',
                    data: {
                        id: id,
                    ...
                    success: function(result) {
                        ...
                        $("#event_meeting_date").val(result.event_meeting_date);
                        $("#remark").val(result.remark);
                        $("#meeting_proposer_employee").val(result.meeting_proposer_employee).change();
                        $("#meeting_participant_employee").val(result
                            .meeting_participant_employee.split(',')).change();
                        ...
                        $("#myLargeModalLabel").text("Edit Event & Meeting")
                        $("#add-edit-btn").text("update");
                        let formaction =
                            '{{ route('admin_process.activity_documents.update-event-meeting') }}';
            ...
            $('.add-edit_modal').on('hidden.bs.modal', function() {
                $("#myLargeModalLabel").text("Add Event & Meeting");
                $("#add-edit-btn").text("Add");
                $('#event-meeting_form').trigger("reset");
                $("#store_logo").text('');
                let formaction = '{{ route('admin_process.activity_documents.store-event-meeting') }}';
                $("#add-edit-btn").attr("formaction", formaction);
