                ...
                <div>
                    <div>
                        <button type="button" class="btn btn-info mb-2 mr-2" data-toggle="modal"
                            ...
                            </svg>Add Training Certificate </button>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myLargeModalLabel">Add Training Certificate</h5>
                                ...
                                <form id="training-feedback_form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row" style="padding: 10px;">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <select class="form-control select2"
                                            name="certificate_template" id="certificate_template">
                                        ...
                                        <div class="form-group" align="center"
                                            ...
                                            <button
                                                formaction="{{ route('admin_process.activity_documents.store-training-certificate') }}"
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete', function() {
                ...
                swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ route('admin_process.activity_documents.delete-training-certificate') }}",
                            method: "GET",
                            dataType: 'json',
                            data: {
                                id: id,
            ...
            $(document).on('click', '.edit', function() {
                let id = $(this).attr('id');
                $.ajax({
                    url: "{{ route('admin_process.activity_documents.edit-training-certificate') }}",
                    method: "GET",
                    dataType: 'json',
                    data: {
                        id: id,
                    ...
                    success: function(result) {
                        ...
                        $("#training_participant_employee").val(result.training_participant_employee);
                        $("#certificate_template").val(result.certificate_template);
                        ...
                        $("#myLargeModalLabel").text("Edit Training Certificate")
                        $("#add-edit-btn").text("update");
                        let formaction =
                            '{{ route('admin_process.activity_documents.update-training-certificate') }}';
            ...
            $('.add-edit_modal').on('hidden.bs.modal', function() {
                $("#myLargeModalLabel").text("Add Training Certificate");
                $("#add-edit-btn").text("Add");
                $('#training-feedback_form').trigger("reset");
                $("#store_logo").text('');
                let formaction = '{{ route('admin_process.activity_documents.store-training-certificate') }}';
                $("#add-edit-btn").attr("formaction", formaction);
            ...
            var table = $('.datatable_server').DataTable({
                ...
                "ajax": {
                    url: "{{ route('admin_process.activity_documents.get-training-certificate') }}",
                    type: "get",
                    data: function(d) {}
                },
                columns: [{
...

                    {
                        ...
                        orderable: true,
                        name: "certificate_template" /*,width:"20%"*/
                    },
                    {
                        data: "remark",
                        orderable: true,
