...
<div id="content" class="main-content">
    ...
    @csrf
            <div class="row" style="padding: 10px;">
                                        ...
                                        <div class="col-md-3 form-group">
                                            <label>Select Location*</label>
                                            <select name="location_id" id="location_id" class="form-control selectpicker" data-live-search="true" data-live-search-style="begins" title='Select Employee...'>
                                                <option value="361">Select location</option>
                                        ...
                                        <div class="col-md-3 form-group">
                                            <label>Select Department*</label>
                                            <select name="department_id" id="department_id" class="form-control selectpicker" data-live-search="true" data-live-search-style="begins" title='Select Employee...'>
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <select name="service_id" id="service_id" class="form-control selectpicker" data-live-search="true" data-live-search-style="begins" title='Select Employee...'>
                ...
                <button type="button" class="delete-row btn btn-danger" style="margin-left: 90%; margin-top: 5px;">Delete Row</button>
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="number" required class="form-control" placeholder="" name="total_amount" id="total_amount" value="0">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label>Add Agreement Period*</label>
                                            <input type="text" required class="form-control" placeholder="" name="agreement_period" id="agreement_period">
                                        </div>
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="number" required class="form-control" placeholder="" name="agreement_value" id="agreement_value" value="0">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label>Approved By - Signing Authority Name*</label>
                                            <input type="text" required class="form-control" placeholder="" name="approved_by" id="approved_by_name" >
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label>Approved By - Signing Authority Designation*</label>
                                            <input type="text" required class="form-control" placeholder="" name="approved_by_designation" id="approved_by_designation" >
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label>Approval Date*</label>
                                            <input type="date" required class="form-control" placeholder="" name="approved_date" id="approved_date" value="0">
                                        </div>
                                        <div class="col-md-3 form-group">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" required class="form-control"  name="generated_agreement_number" id="generated_agreement_number" value="AN-{{ time() }}" readonly>
                                        </div>
            </div>
            <div class="row" style="padding: 10px;">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#add_row").click(function(){
                ...
                {
                    var markup = "<tr><td><input type='checkbox' class='del_check1' name='record'></td><td><input type='text' class='form-control' name='service_id[]' value='"+ service_id +"' ></td><td><input type='number' class='form-control' name='quantity[]' value='"+ quantity +"' ></td><td><input type='number' step='0.1' class='form-control' name='rate[]' value='"+ rate +"' ></td><td><input type='text' class='form-control'  name='details[]' value='"+ details +"' ></td></tr>";
