            ...
            <div class="row" style="padding: 10px;">
                ...
                <div class="col-md-3 form-group">
                    ...
                    <select name="vendor_category_id" id="vendor_category_id" class="form-control selectpicker" data-live-search="true" data-live-search-style="begins" title='Select Employee...'>
                                    <option value="361">Select Vendor Category</option>
                ...
                <div class="col-md-3 form-group">
                    ...
                    <select name="expense_category_id" id="expense_category_id" class="form-control selectpicker" data-live-search="true" data-live-search-style="begins" title='Select Employee...'>
                                    <option value="361">Select Expenses Category</option>
                ...
                <div class="col-md-2 form-group">
                    ...
                    <input type="text" required class="form-control" placeholder="" name = "po_wo_validity_days">
                </div>
                <div class="col-md-3 form-group">
                ...
                <div class="col-md-3 form-group">
                    ...
                    <input type="text" value="{{'PO'.time()}}" readonly="readonly" required class="form-control" placeholder="" name="generate_po_wo_number">
                </div>
                <!-- 
                <div class="col-md-2 form-group">
                    <label>No Of Vaccancy*</label>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="Delete" class="delete_stored" id="{{$purchase_work_order->id}}"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round"
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#add_row").click(function(){
                ...
                {
                    var markup = "<tr><td><input type='checkbox' class='del_check1' name='record'></td><td><input type='number' class='form-control' name='quantity[]' value='"+ quantity +"' ></td><td><input type='number' class='form-control' step='0.1' name='rate[]' value='"+ rate +"' ></td><td><input type='text' class='form-control'  name='details[]' value='"+ details +"' ></td></tr>";
