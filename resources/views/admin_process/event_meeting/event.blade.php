                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myLargeModalLabel">Add Events</h5>
                                ...
                                <form id="events_form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row" style="padding: 10px;">
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label> Select Event Coordinator Employees * </label>
                                            <select class="form-control select2" multiple="multiple"
                                                name="event_coordinator_employee[]" id="event_coordinator_employee">
                                        ...
                                        <div class="form-group" align="center"
                                            ...
                                            <button formaction="{{ route('admin_process.event_meeting.store-events') }}"
        ...
        $(document).ready(function() {
            ...
            $('#events_form').validate({
                ...
                messages: {
                    ...
                    event_type: {
                        required: "Please select events type.",
                        // notEqual:"Please select other employee."
                    },
                    event_date: {
            ...
            $(document).on('click', '.delete', function() {
                ...
                swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ route('admin_process.event_meeting.delete-events') }}",
                            method: "GET",
                            dataType: 'json',
                            data: {
                                id: id,
            ...
            $(document).on('click', '.edit', function() {
                let id = $(this).attr('id');
                $.ajax({
                    url: "{{ route('admin_process.event_meeting.edit-events') }}",
                    method: "GET",
                    dataType: 'json',
                    data: {
                        id: id,
                    ...
                    success: function(result) {
                        ...
                        $("#myLargeModalLabel").text("Edit Events")
            ...
            $('.add-edit_modal').on('hidden.bs.modal', function() {
                $("#myLargeModalLabel").text("Add Events");
                $("#add-edit-btn").text("Add");
                $('#events_form').trigger("reset");
                $("#store_logo").text('');
                let formaction = '{{ route('admin_process.event_meeting.store-events') }}';
                $("#add-edit-btn").attr("formaction", formaction);
            ...
            var table = $('.datatable_server').DataTable({
                ...
                "ajax": {
                    url: "{{ route('admin_process.event_meeting.get-events') }}",
                    type: "get",
                    data: function(d) {}
                },
                columns: [{
                    ...
                    },
                    {
                        data: "event_date",
                        orderable: true,
                        name: "event_date" /*,width:"20%"*/
                    },
                    {
                        data: "event_type",
                        orderable: true,
                        name: "event_type" /*,width:"20%"*/
                    },


                    {
                        data: "event_proposer_employee",
                        orderable: true,
                        name: "event_proposer_employee" /*,width:"20%"*/
                    },
                    {
                        data: "event_coordinator_employee",
                        orderable: true,
                        name: "event_coordinator_employee" /*,width:"20%"*/
                    },
                    {
                        data: "vendor_id",
                        orderable: true,
