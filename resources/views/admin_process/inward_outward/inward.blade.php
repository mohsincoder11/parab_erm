                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myLargeModalLabel">Add Inward</h5>
                                ...
                                <form id="inward_form" method="post">
                                    @csrf
                                    ...
                                    <div class="row" style="padding: 10px;">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="date" name="received_date" id="received_date" required class="form-control"
                                        ...
                                        <div class="form-group" align="center"
                                            ...
                                            <button formaction="{{ route('admin_process.inward_outward.store-inward') }}"
        ...
        $(document).ready(function() {
            ...
            $('#inward_form').validate({
                ...
                messages: {
                    ...
                    inward_type: {
                        required: "Please select inward type.",
                        // notEqual:"Please select other employee."
                    },
                    from_name: {
            ...
            $(document).on('click', '.delete', function() {
                ...
                swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ route('admin_process.inward_outward.delete-inward') }}",
                            method: "GET",
                            dataType: 'json',
                            data: {
                                id: id,
            ...
            $(document).on('click', '.edit', function() {
                let id = $(this).attr('id');
                $.ajax({
                    url: "{{ route('admin_process.inward_outward.edit-inward') }}",
                    method: "GET",
                    dataType: 'json',
                    data: {
                        id: id,
                    ...
                    success: function(result) {
                        ...
                        $("#myLargeModalLabel").text("Edit Inward")
                        $("#add-edit-btn").text("update");
                        let formaction =
                            '{{ route('admin_process.inward_outward.update-inward') }}';
            ...
            $('.add-edit_modal').on('hidden.bs.modal', function() {
                $("#myLargeModalLabel").text("Add Inward");
                $("#add-edit-btn").text("Add");
                $('#inward_form').trigger("reset");
                $("#store_logo").text('');
                let formaction = '{{ route('admin_process.inward_outward.store-inward') }}';
                $("#add-edit-btn").attr("formaction", formaction);
            ...
            var table = $('.datatable_server').DataTable({
                ...
                "ajax": {
                    url: "{{ route('admin_process.inward_outward.get-inward') }}",
                    type: "get",
                    data: function(d) {}
                },
                columns: [{
                    ...
                    },
                    {
                        data: "inward_type",
                        orderable: true,
                        name: "inward_type" /*,width:"20%"*/
                    },
                    {
                        data: "received_date",
                        orderable: true,
                        name: "received_date" /*,width:"20%"*/
                    },
                    {
                        data: "to_name",
                        orderable: true,
