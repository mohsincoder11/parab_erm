        ...
        <div class="layout-px-spacing">
            ...
            <div style=" background-color:white; margin-top: 10px;">
                ...
                <div style="padding-top: 15px; font-size: 30px; margin-left: 1%; ">
                    <h3 style="color:rgb(36, 36, 191) ;"><b>Outwards Report</b></h3>

                </div>

                <div class="layout-px-spacing">
                    <form action="{{ route('admin_report.outward-report') }}" method="get">
                    ...
                    <div class="widget-content widget-content-area br-6">
                        <div class="table-responsive mb-4 mt-4">
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($outwards_report as $outwards_report)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td>{{ $outwards_report->company_name }}</td>
                                            <td>{{ $outwards_report->location_name }}</td>
                                            <td>{{ $outwards_report->department }}</td>
                                            <td>{{ $outwards_report->outward_type }}</td>
                                            <td>{{ $outwards_report->outward_date }}</td>
                                            <td>{{ $outwards_report->inward_number }}</td>
                                            <td>{{ $outwards_report->to_name }}</td>
                                            <td>{{ $outwards_report->courier_name }}</td>
                                            <td>{{ $outwards_report->awb_number }}</td>
                                            <td>{{ $outwards_report->employee_name }}</td>
                                            <td>{{ $outwards_report->outward_number }}</td>
                                            <td>
                                                <a 
                                    href="{{route('admin_report.fetch_outward_report',$outwards_report->id)}}" data-toggle="tooltp"
