        ...
        <div class="layout-px-spacing">
            ...
            <div style=" background-color:white; margin-top: 10px;">
                ...
                <div style="padding-top: 15px; font-size: 30px; margin-left: 1%; ">
                    <h3 style="color:rgb(36, 36, 191) ;"><b>Training Certificate Report</b></h3>

                </div>

                <div class="layout-px-spacing">
                    <form action="{{ route('admin_report.training-certificate-report') }}" method="get">
                        ...
                        <div class="col-md-3 form-group">
                            <label> Select Training Participant * </label>
                            ...
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($training_report as $training_report)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td>{{ $training_report->company_name }}</td>
                                            <td>{{ $training_report->location_name }}</td>
                                            {{-- <td>{{ $training_report->department }}</td> --}}
                                            <td>{{ $training_report->training_start_time }}</td>
                                            <td>{{ $training_report->training_end_time }}</td>
                                            <td>{{ $training_report->training_start_date }}</td>
                                            <td>{{ $training_report->training_end_date }}</td>
                                            <td>{{ $training_report->meeting_participant_employee }}</td>
                                            {{-- <td>{{ $training_report->vendor_id }}</td> --}}
                                            <td>{{ $training_report->estimate_training_cost }}</td>
                                            <td>{{ $training_report->training_code }}</td>
                                            <td>
                                                <a 
                                    href="{{route('admin_report.fetch_training_report',$training_report->id)}}" data-toggle="tooltp"
