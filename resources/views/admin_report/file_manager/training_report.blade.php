        ...
        <div class="layout-px-spacing">
            ...
            <div style=" background-color:white; margin-top: 10px;">
                ...
                <div style="padding-top: 15px; font-size: 30px; margin-left: 1%; ">
                    <h3 style="color:rgb(36, 36, 191) ;"><b>Training Report</b></h3>

                </div>

                <div class="layout-px-spacing">
                    <form action="{{ route('admin_report.training-report') }}" method="get">
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <select class="form-control" name="trainer_id" id="trainer_id">
                                @foreach ($vendor as $trainer)
                                    <option value="{{ $trainer->id }}">{{ $trainer->vendor_name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <select name="training_id" id="training_id" class="form-control selectpicker"
                    ...
                    <div class="widget-content widget-content-area br-6">
                        <div class="table-responsive mb-4 mt-4">
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($training_calender_report as $training_calender_report)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td>{{ $training_calender_report->company_name }}</td>
                                            <td>{{ $training_calender_report->location_name }}</td>
                                            <td>{{ $training_calender_report->department }}</td>
                                            <td>{{ $training_calender_report->training_start_time }}</td>
                                            <td>{{ $training_calender_report->training_end_time }}</td>
                                            <td>{{ $training_calender_report->trainer_name }}</td>
                                            <td>{{ $training_calender_report->proposer_employee }}</td>
                                            <td>{{ $training_calender_report->proposer_employee }}</td>
                                            {{-- <td>{{ $training_calender_report->trainer_name }}</td> --}}
                                            <td>{{ $training_calender_report->estimate_training_cost }}</td>
                                            <td>{{ $training_calender_report->training_code }}</td>
                                            <td>
                                                <a 
                                    href="{{route('admin_report.fetch_training_calender_report',$training_calender_report->id)}}" data-toggle="tooltp"
