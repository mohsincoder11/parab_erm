<div class="tab-pane fade" id="v-line-pills-document" role="tabpanel" aria-labelledby="v-line-pills-document-tab">
                                                                    <h5 class="mb-4">All Documents</h5>
                                                                    <div>
                                                                        <button type="button" class="btn btn-info mb-2 mr-2" data-toggle="modal" data-target=".bd-example-modal-lg2"><svg
                                                                                ...
                                                                                <div class="row" style="padding: 10px;">
                                                                                    <div class="col-md-6 form-group">
                                                                                        ...
                                                                                        <select class="form-control selectpicker" data-live-search="true" data-live-search-style="begins" title='Select Company Type...'>
                                                                                            ...
                                                                                            <option value="1">Driving Licesnse</option>
                                                                            <option value="2">Passport</option>
                                                                            <option value="3">National Id</option>
                                                                            <option value="4">Aadhar Card</option>
                                                                            <option value="5">Voter ID</option>
                                                                            <option value="6">Transfer Certificate</option>
                                                                            <option value="7">Pan Card</option>
                                                                            <option value="8">Contract Copy</option>
                                                                            <option value="9">Bank Passbook</option>
                                                                            <option value="10">Curriculum vitae</option>
                                                                            <option value="11">Marksheet</option>
                                                                            <option value="12">Experiences Certificate</option>
                                                                            <option value="13">Other</option>
                                                                            <option value="14">Degree Certificate</option>
                                                                                    ...
                                                                                    <div class="col-md-6 form-group">
                                                                                        ...
                                                                                        <input type="file" name="company_logo" id="company_logo" class="form-control" placeholder=Optional>
