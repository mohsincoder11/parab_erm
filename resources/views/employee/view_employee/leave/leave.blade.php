<div class="tab-pane fade" id="justify-pills-leave" role="tabpanel" aria-labelledby="justify-pills-leave-tab">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                                                <div class="widget-content widget-content-area br-6">
                                                    <div class="table-responsive mb-4 mt-4">
                                                        <table id="alter_pagination17" class="table table-hover" style="width:100%">
                                                            <thead>
                                                                <tr>
                                                                    <th>Leave Type</th>
                                                                    <th>Department</th>
