                    ...
                    <div class="modal fade add-edit_modal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                @endphp
                                <form method="post" id="salary_bank_form" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="id" id="salary_bank_id">
                                    ...
                                    <div class="row" style="padding: 10px;">
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Upload Salary Format* </label>
                                            <input type="file" name="salary_format" id="salary_format" class="form-control"
                                        ...
                                        <div class="form-group" align="center" style="margin-top: 5%; margin-left: 45%;">
                                            ...
                                            <button formaction="{{ route('banks_masters.store-salary_bank') }}"
        ...
        $(document).ready(function() {
            ...
            $('#salary_bank_form').validate({
                ...
                messages: {
                    ...
                    salary_format: {
                        required: 'Please select salary format.',
                    },
            ...
            $(document).on('click', '.edit', function() {
                let id = $(this).attr('id');
                $.ajax({
                    url: "{{ route('banks_masters.edit-salary_bank') }}",
                    method: "GET",
                    dataType: 'json',
                    data: {
                        id: id,
                    ...
                    success: function(result) {
                        $("#salary_format").addClass('ignore');

                        $("#salary_bank_id").val(result.id);
                        $("#bank_id").val(result.bank_id);
                        $("#company_id").val(result.company_id);
                        $("#store_logo").text(result.salary_format);
                        $("#old_file").val(result.salary_format);
                        ...
                        let formaction = '{{ route('banks_masters.update-salary_bank') }}';
            ...
            $('.add-edit_modal').on('hidden.bs.modal', function() {
                ...
                $('#salary_bank_form').trigger("reset");
                let formaction = '{{ route('banks_masters.store-salary_bank') }}';
                $("#add-edit-btn").attr("formaction", formaction);
                $("#salary_format").removeClass('ignore');
            ...
            $(document).on('click', '.delete', function() {
                ...
                swal({
                    ...
                    if (result.value) {
                    $.ajax({
                        url: "{{ route('banks_masters.delete-salary_bank') }}",
                        method: "GET",
                        dataType: 'json',
                        data: {
                            id: id,
            ...
            var table = $('.datatable_server').DataTable({
                ...
                "ajax": {
                    url: "{{ route('banks_masters.get-salary_bank') }}",
                    type: "get",
                    data: function(d) {}
                },
                columns: [{
