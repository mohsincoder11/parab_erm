                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="row" style="padding: 10px;">
                                ...
                                <div class="col-md-6 form-group">
                                    <label>Company*</label>
                                    <select name="company_id" id="company_editid" class="form-control selectpicker company_id"
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" required class="form-control" name="department" id="department" placeholder="Unique Value">
                                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            data-custom-value="{{$department->id}}" class="edit"
                                            ...
                                            data-custom-value="{{$department->id}}" class="delete"
