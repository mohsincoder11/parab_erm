                                    ...
                                    <form method="post" id="personal_detail_form">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" name="blood_group" id="blood_group" required
                                                class="form-control" placeholder="Bllod Group">
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="email" name="personal_email" id="personal_email" required
                                                class="form-control" placeholder="">
                                        </div>
                                      
                                        <div class="col-md-6 form-group">
                                            <label>Spouse or Emergency Mobile No. </label>
                                            <input type="number" name="emergency_contact_no" id="emergency_contact_no" required
                                                class="form-control" placeholder="">
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" name="driving_license_no" id="driving_license_no" required
