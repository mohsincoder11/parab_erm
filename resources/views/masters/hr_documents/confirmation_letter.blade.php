                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myLargeModalLabel">Add Confirmation Letter</h5>
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            $('#confirmation_letter_form').validate({
                //debug:true,
                ignore: ".ignore",
                rules: {
                    company_id: {
            ...
            var table = $('.datatable_server').DataTable({
                ...
                "ajax": {
                    url: "{{ route('hr_document.get_confirmation_letter_record') }}",
                    type: "get",
                    data: function(d) {}
                },
                columns: [{
