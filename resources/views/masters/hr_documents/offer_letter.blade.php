                    ...
                    <div class="modal fade add-edit_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <form enctype="multipart/form-data" id="offer_letter_form" method="post">
                                    @csrf
                                    <div class="row" style="padding: 10px;">
                                        ...
                                        <div class="form-group" align="center"
                                            ...
                                            <button formaction="{{ route('hr_document.store-offer-letter') }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.edit', function() {
                let id = $(this).attr('id');
                $.ajax({
                    url: "{{ route('hr_document.edit-offer-letter') }}",
                    method: "GET",
                    dataType: 'json',
                    data: {
                        id: id,
                    ...
                    success: function(result) {
                        ...
                        $("#myLargeModalLabel").text("Edit Offer Letter")
                        $("#add-edit-btn").text("Update");
                        let formaction = '{{ route('hr_document.update-offer-letter') }}';
            ...
            $('.add-edit_modal').on('hidden.bs.modal', function() {
                ...
                $("#store_logo").text('');
                let formaction = '{{ route('hr_document.store-offer-letter') }}';
                $("#add-edit-btn").attr("formaction", formaction);
            ...
            var table = $('.datatable_server').DataTable({
                ...
                "ajax": {
                    url: "{{ route('hr_document.get_offer_letter_record') }}",
                    type: "get",
                    data: function(d) {}
                },
                columns: [{
