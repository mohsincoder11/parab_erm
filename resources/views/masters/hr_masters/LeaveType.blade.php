                    ...
                    <div>
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="myLargeModalLabel">Add Leave Type</h5>
                                    ...
                                    @csrf
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" name="leave_type" required class="form-control">
                                        </div>
                                        
                                        <div class="col-md-6 form-group">
                                            <label>No of Days *</label>
                                            <input type="number" min="1" name="allocated_day" required class="form-control">
                                        </div>
                        ...
                        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="editmodel" 
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="myLargeModalLabel">Edit Leave Type</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <form id="update_form" action="" method="POST">
                                    ...
                                    <div class="row" style="padding: 10px;">
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>No of Days *</label>
                                            <input type="number" min="1" id="allocated_day" name="allocated_day" required class="form-control">
                                        </div>
        ...
        <script type="text/javascript">
            ...
            $('#html5-extension').on('click', '.edit', function () {
                ...
                var id = data.customValue;
                        console.log(id)
                var target = "{{ url('editLeaveType')}}/" + id;
                ...
                $.ajax({
                    ...
                    success: function (html) {
                        ...
                        $('#leave_type').val(html.result.leave_type);
                        $('#allocated_day').val(html.result.allocated_day)
            ...
            $('#html5-extension').on('click', '.delete', function () {
                ...
                swal({
                    ...
                    if (result.value) {
                        var target = "{{ url('deleteLeaveType')}}/" + id;
