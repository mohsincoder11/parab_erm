                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="myLargeModalLabel">Add New Status</h5>
                                ...
                                <option value="private foundation">Pbxdghb</option>
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <select name="company_type" id="company_type"
                                                ...
                                                data-live-search-style="begins" title='Select Company Type...'>
                                                <option value="" disabled selected>Select Status </option>
                                                <option value="corporation">Probation</option>
                                                <option value="exempt organization">Trainee</option>
                                                <option value="partnership">Permanent</option>
                                                <option value="exempt organization">Part time </option>
                                                <option value="partnership">Contractual </option>
